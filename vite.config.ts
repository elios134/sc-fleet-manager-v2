...
export default defineConfig(async () => ({
  ...
  // Découpage du bundle : sort les grosses libs vendors (three.js/r3f, React) dans
  // des chunks séparés → main plus léger, meilleur cache navigateur, chargement parallèle.
  build: {
